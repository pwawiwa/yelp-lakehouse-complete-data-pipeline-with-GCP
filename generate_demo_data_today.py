...
# ==========================================
# DEMO DATA GENERATION CONFIG for TODAY
# ==========================================
# Current batch date
TARGET_DT = "2026-03-31"

# Target IDs for SCD Type 2 demonstration
# (These will be initial records inserted today, and UPDATED on the April 1st batch)
...
def main():
    ...
    # We create a slightly different volume for today's initial load
    counts = {
        "business": 300,
        "user": 300,
        "review": 600,
    ...
    print(f"🔄 Preparing Initial Baseline Batch for {TARGET_DT}...")
    ...
    for entity in entities:
        ...
        with open(file_path, "w") as f:
            if entity == "business":
                # INITIAL BASE RECORD: This is the record that will be "updated" on April 1
                f.write(json.dumps(generate_business_record(UPDATE_BUSINESS_ID)) + "\n")
                # SCHEMA EVOLUTION: Record 2 (Added to March 31 batch to evolve schema early)
